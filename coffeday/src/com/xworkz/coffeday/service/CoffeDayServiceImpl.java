package com.xworkz.coffeday.service;
...
import com.xworkz.coffeday.repository.CoffeDayRepo;

@Component
public class CoffeDayServiceImpl implements CoffeDayService {
	@Autowired
	private CoffeDayRepo repo;

	public CoffeDayServiceImpl(CoffeDayRepo repo) {
		this.repo = repo;
	}

	@Override
	public boolean validateandsave(CoffeDayEntity entity) {
		boolean valid = false;
