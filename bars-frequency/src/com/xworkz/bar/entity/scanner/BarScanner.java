...
public class BarScanner {
	...
	public static void main(String[] args) {
		...
		BarEntity barEntity1 = new BarEntity(null, "om@gmail.com", 9875433321l, "jp nagar ", "nagappa", 5, 10, 3,
				"shisai", LocalDateTime.now(), "kiran", LocalDateTime.now());
		BarEntity barEntity2 = new BarEntity("Communiti", "sai@gmail", 9874561236l, "Brigade Road", "kaagappa", 3,
				20, 3, "shisai", LocalDateTime.now(), "kiran", LocalDateTime.now());
		BarEntity barEntity3 = new BarEntity("Vishwas Bar", "shiva@gmail.com", 81345567894l, "Krishna murti Layout",
				"nagappa", 5, 25, 3, "shisai", LocalDateTime.now(), "kiran", LocalDateTime.now());
		BarEntity barEntity4 = new BarEntity("Tipsy Bull the Bar", "kiran@gmail.com", 7894561234l, "Ring road Btm",
				"nagappa", 2, 35, 3, "shisai", LocalDateTime.now(), "kiran", LocalDateTime.now());
		BarEntity barEntity5 = new BarEntity("Swarnaloka Bar", "umesh@gmail.com", 8794561231l, "BTM complex", "nagappa",
				3, 40, 3, "shisai", LocalDateTime.now(), "kiran", LocalDateTime.now());
		...
		BarService barDAO2 = new BarServiceImpl(barDAO);
