...
public class PassportDirector {
	...
	("kiran", LocalDateTime.of(2022,4,5,13,43,37), LocalDateTime.of(2035,5,6,12,12), Gender.MALE,
	...
	BloodGroup.A_POSITIVIE, VerifiedDocument.LICENCE);
		...
		PassportService service = 	applicationContext.getBean(PassportService.class);
