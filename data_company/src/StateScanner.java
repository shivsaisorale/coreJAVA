...
public class StateScanner {
	...
	public static void main(String[] args) {
		...
		StateEntity stateEntity1 = new StateEntity(1, "Karanatak", 30, "Namma Bengaluru");
		StateEntity stateEntity2 = new StateEntity(2, "Maharashtra", 28, "Mumbai ");
		StateEntity stateEntity3 = new StateEntity(3, "Andhar Pradesh", 31, "Amaravati");
		StateEntity stateEntity4 = new StateEntity(4, "Madya Pradesh", 32, "Bhopala ");
